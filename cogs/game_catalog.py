...
WEAPONS: tuple[CatalogEntry, ...] = (
    _entry("sword", "Great Sword", "sword", "greatsword", "gsword", prefix="weapon"),
    _entry("hstaff", "Healing Staff", "hstaff", "heal staff", "healstaff", prefix="weapon"),
    ...
    _entry("vstaff", "Vampiric Staff", "vstaff", "vamp staff", "vampstaff", prefix="weapon"),
    _entry("pd", "Poison Dagger", "pd", "dagger", "pdagger", "pdag", prefix="weapon"),
    _entry("wand", "Wand of Absorption", "wand", "awand", "absorption wand", prefix="weapon"),
    ...
    _entry("scepter", "Arcane Scepter", "scepter", "ascept", "arcane", prefix="weapon"),
    _entry("rstaff", "Resurrection Staff", "rstaff", "res staff", prefix="weapon"),
    _entry("axe", "Glacial Axe", "axe", "gaxe", prefix="weapon"),
    _entry("vban", "Vanguard's Banner", "vban", "banner", prefix="weapon"),
    _entry("sythe", "Culling Scythe", "sythe", "scythe", "csyth", "csy", prefix="weapon"),
    _entry("crune", "Rune of Celebration", "crune", "cel", "celebration rune", prefix="weapon"),
    _entry("pstaff", "Staff of Purity", "pstaff", "purity staff", prefix="weapon"),
    _entry("lsy", "Leeching Scythe", "lsy", "lsyth", "lscythe", "leech scythe", prefix="weapon"),
    ...
    _entry("soul", "Soul Tithe", "soul", "stithe", "tithe", prefix="weapon"),
    ...
    _entry("xbow", "Wounding Crossbow", "xbow", "woundb", "crossbow", "wbow", "wcbow", prefix="weapon"),
    _entry("bgaz", "Bleeding Gaze", "bgaz", "gaze", "bgaze", prefix="weapon"),
    _entry("claw", "Conduit Claw", "claw", "cclaw", prefix="weapon"),
)


PASSIVES: tuple[CatalogEntry, ...] = (
    _entry("str", "Strength", "str", "att", prefix="passive"),
    ...
    _entry("mtap", "Mana Tap", "mtap", "manatap", prefix="passive"),
    ...
    _entry("kk", "Kamikaze", "kk", "kkaze", prefix="passive"),
    _entry("hgen", "Regeneration", "hgen", "regen", prefix="passive"),
    _entry("wgen", "Energize", "wgen", "energ", prefix="passive"),
    ...
    _entry("kno", "Knowledge", "kno", "n", prefix="passive"),
    _entry("gslay", "Giant Slayer", "gslay", "slay", "slayer", prefix="passive"),
    _entry("adapt", "Adaptation", "adapt", prefix="passive"),
    _entry("res", "Resonance", "res", "reso", prefix="passive"),
    _entry("swarm", "Living Hive", "swarm", "hive", "lhive", prefix="passive"),
    _entry("lwolf", "Lone Wolf", "lwolf", "wolf", prefix="passive"),
    _entry("ds", "Double Strike", "ds", "dstrike", "strike", prefix="passive"),
    _entry("fr", "Frost Armor", "fr", "frarm", "armor", prefix="passive"),
)
